...
namespace Lean.Touch
{
	...
	public class LeanFingerHeld : MonoBehaviour
	{
		...
		public Vector3Event OnWorldSet { get { if (onWorldSet == null) onWorldSet = new Vector3Event(); return onWorldSet; } } [FormerlySerializedAs("onPositionSet")] [SerializeField] private Vector3Event onWorldSet;
...
namespace Lean.Touch
{
	...
	public class LeanFingerHeld_Inspector : LeanInspector<LeanFingerHeld>
	{
		...
		protected override void DrawInspector()
		{
			...
			var usedE = Any(t => t.OnWorldSet.GetPersistentEventCount() > 0);
